...
\djsSolnHeader{1st Order Differential Equations - Integrating Factor}
...
% ---- Question 1 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q1]
...
% ---- Question 2 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q2]
...
% ---- Question 3 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q3]
...
% ---- Question 4 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q4]
...
% ---- Question 5 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q5]
...
% ---- Question 6 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q6]
...
% ---- Question 7 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q7]
...
% ---- Question 8 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q8]
...
% ---- Question 9 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q9]
...
\begin{enumerate}[label=\textbf{(\alph*)}, resume]
  ...
  \]
  where $-\frac{\pi}{2}<x<\frac{\pi}{2}$. \marks{5}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  \item
  \begin{align*}
  \frac{\mathrm{d}}{\mathrm{d}x}\ln(\sec x+\tan x)
  &=\frac{\sec x\tan x+\sec^2 x}{\sec x+\tan x}\\
  &=\frac{\sec x(\tan x+\sec x)}{\sec x+\tan x}\\
  &=\sec x
  \end{align*}

  \item The equation is linear, with
  \[
  P(x)=-2\tan x.
  \]
  An integrating factor is
  \begin{align*}
  \mu(x)
  &=e^{\int -2\tan x\,\mathrm{d}x}\\
  &=e^{2\ln(\cos x)}\\
  &=\cos^2 x,
  \end{align*}
  since $\cos x>0$ for $-\frac{\pi}{2}<x<\frac{\pi}{2}$.

  Multiplying through by $\cos^2 x$,
  \[
...
% ---- Question 10 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q10]
...
% ---- Question 11 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q11]
...
% ---- Question 12 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q12]
...
% ---- Question 13 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q13]
...
% ---- Question 14 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q14]
...
% ---- Question 15 ----
\questionitem
% [Source: _QBT___Solns__Integrating_Factor_Method, Q15]
