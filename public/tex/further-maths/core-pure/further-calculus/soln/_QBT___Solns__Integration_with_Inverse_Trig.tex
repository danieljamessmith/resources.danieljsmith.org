...
\djsSolnHeader{Integration with Inverse Trig}
...
\[
\int \frac{1}{\sqrt{r^2-x^2}}\,\mathrm{d}x=\arcsin \!\left(\frac{x}{r}\right)+c
\]
with \(r=2\) and \(x\) replaced by \(x-2\), we get
\[
I=\lim_{\substack{a\to 0^+\\ b\to 4^-}}\left[\arcsin \!\left(\frac{x-2}{2}\right)\right]_{a}^{b}
\]
...
Here \(a=2\), with \(x\) replaced by \(x-1\). Hence
\[
...
Using part (iii), with $x$ replaced by $t-3$,
\[
\int \frac{1}{16-(t-3)^2}\,\mathrm{d}t
=
\frac18\ln\left(\frac{4+(t-3)}{4-(t-3)}\right)+c
\]
...
\int_1^5 \frac{1}{-t^2+6t+7}\,\mathrm{d}t
&=
\left[\frac18\ln\left(\frac{t+1}{7-t}\right)\right]_{1}^{5} \\
...
With $a=3$ and $x$ replaced by $x-2$,
\[
...
\begin{align*}
I
&=\frac{1}{\sqrt{2}}\left[\arcsin\!\left(\frac{x-2}{3}\right)\right]_{1}^{4}\\
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  ...
  \int \frac{1}{x^2+a^2}\,\mathrm{d}x=\frac{1}{a}\arctan\!\left(\frac{x}{a}\right)+c
  \]
  with $a=3$ and $x$ replaced by $x-3$, we get
  \[
...
\int \frac{1}{x^2+a^2}\,\mathrm{d}x=\frac{1}{a}\arctan\!\left(\frac{x}{a}\right)+c
\]
with $a=2$ and $x$ replaced by $x-2$.
...
Using the standard result
\[
\int \frac{1}{a^2+x^2}\,\mathrm{d}x=\frac1a\arctan\left(\frac{x}{a}\right)+c
\]
with \(a=3\) and \(x\) replaced by \(2x-2\), noting that \(\dfrac{\mathrm{d}}{\mathrm{d}x}(2x-2)=2\),
\begin{align*}
7\int \frac{1}{(2x-2)^2+9}\,\mathrm{d}x
&=7\cdot \frac12\cdot \frac13 \arctan\left(\frac{2x-2}{3}\right) \\
&=\frac76 \arctan\left(\frac{2x-2}{3}\right)
\end{align*}
...
\]
with \(f(x)=x^2-4x+8\). Then
\[
2\int \frac{2x-4}{x^2-4x+8}\,\mathrm{d}x
=2\ln(x^2-4x+8)
\]
since \(x^2-4x+8=(x-2)^2+4>0\).
...
\]
with \(a=2\) and \(x\) replaced by \(x-2\). Hence
\[
7\int \frac{1}{(x-2)^2+4}\,\mathrm{d}x
...
\item Since
\[
\sqrt{4x^2-9}=3\sqrt{\left(\frac{2x}{3}\right)^2-1}
\]
and
\[
\frac{\mathrm{d}}{\mathrm{d}x}\left(\frac{2x}{3}\right)=\frac23
\]
we use the result from part (i), with \(x\) replaced by \(\dfrac{2x}{3}\):
\[
\int \frac{1}{\sqrt{4x^2-9}}\,\mathrm{d}x
=
\frac12\operatorname{arcosh}\left(\frac{2x}{3}\right)+c
\]

Therefore
\[
\int_{15/8}^{5/2}\frac{1}{\sqrt{4x^2-9}}\,\mathrm{d}x
=\left[\frac12\operatorname{arcosh}\left(\frac{2x}{3}\right)\right]_{15/8}^{5/2}
...
\frac{1}{a}\arctan\!\left(\frac{x}{a}\right)+C
\]
with $a=\frac43$ and $x$ replaced by $x+\frac23$,
\begin{align*}
\int \frac{1}{9x^2+12x+20}\,\mathrm{d}x
&=\frac19\cdot \frac{1}{4/3}
\arctan\!\left(\frac{x+\frac23}{4/3}\right)+C \\
...
&=9\left[\frac{49}{9}-\left(x-\frac23\right)^2\right] \\
&=9\left[\left(\frac73\right)^2-\left(x-\frac23\right)^2\right]
\end{align*}

So
\begin{align*}
\int \frac{1}{\sqrt{45+12x-9x^2}}\,\mathrm{d}x
&=\int \frac{1}{\sqrt{9\left[\left(\frac73\right)^2-\left(x-\frac23\right)^2\right]}}\,\mathrm{d}x \\
&=\frac13\int \frac{1}{\sqrt{\left(\frac73\right)^2-\left(x-\frac23\right)^2}}\,\mathrm{d}x
\end{align*}
...
\]
with $a=\frac73$ and $x$ replaced by $x-\frac23$,
\begin{align*}
\int \frac{1}{\sqrt{45+12x-9x^2}}\,\mathrm{d}x
&=\frac13\arcsin\!\left(\frac{x-\frac23}{7/3}\right)+C \\
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  ...
  \int \frac{1}{x^2+a^2}\,\mathrm{d}x=\frac{1}{a}\arctan\!\left(\frac{x}{a}\right)+c
  \]
  with \(a=3\) and \(x\) replaced by \(5x-2\), noting that \(\dfrac{\mathrm{d}}{\mathrm{d}x}(5x-2)=5\), we get
  \begin{align*}
  \int_{-\frac15}^{1}\frac{1}{(5x-2)^2+9}\,\mathrm{d}x
  &= \left[\frac{1}{15}\arctan\!\left(\frac{5x-2}{3}\right)\right]_{-\frac15}^{1} \\
  ...
  \]
  with \(a=3\) and \(x\) replaced by \(5x-2\), noting that \(\dfrac{\mathrm{d}}{\mathrm{d}x}(5x-2)=5\), we have
  \[
  \int \frac{1}{\sqrt{(5x-2)^2+9}}\,\mathrm{d}x
  =
  \frac15\ln\left|(5x-2)+\sqrt{(5x-2)^2+9}\right|+c
  \]

  Hence
  \begin{align*}
  \int_{-\frac15}^{1}\frac{1}{\sqrt{(5x-2)^2+9}}\,\mathrm{d}x
  &= \left[\frac15\ln\left|(5x-2)+\sqrt{(5x-2)^2+9}\right|\right]_{-\frac15}^{1} \\
  &= \frac15\left(\ln(3+3\sqrt2)-\ln(-3+3\sqrt2)\right) \\
...
&=\frac12\frac{\mathrm{d}}{\mathrm{d}x}\left[\ln(1+x)-\ln(1-x)\right] \\
&=\frac12\left(\frac{1}{1+x}+\frac{1}{1-x}\right) \\
&=\frac12\left(\frac{(1-x)+(1+x)}{1-x^2}\right) \\
&=\frac{1}{1-x^2}
\end{align*}
So
\[
\int \frac{1}{1-x^2}\,\mathrm{d}x=\operatorname{artanh}x+c
\]

Now
\[
4-9x^2=4\left(1-\left(\frac{3x}{2}\right)^2\right)
\]
and
\[
\frac{\mathrm{d}}{\mathrm{d}x}\left(\frac{3x}{2}\right)=\frac32
\]
Therefore
\begin{align*}
\int_{1/5}^{2/5}\frac{1}{4-9x^2}\,\mathrm{d}x
&=\frac16\left[\operatorname{artanh}\left(\frac{3x}{2}\right)\right]_{1/5}^{2/5}
\end{align*}
Using the result from part (i),
\begin{align*}
\int_{1/5}^{2/5}\frac{1}{4-9x^2}\,\mathrm{d}x
&=\frac{1}{6}\left[\frac12\ln\left(\frac{1+\frac{3x}{2}}{1-\frac{3x}{2}}\right)\right]_{1/5}^{2/5} \\
&=\frac{1}{12}\left[\ln\left(\frac{1+\frac{3x}{2}}{1-\frac{3x}{2}}\right)\right]_{1/5}^{2/5} \\
...
\]
with $a=2$ and $x$ replaced by $x-1$,
\begin{align*}
A_{\text{units}}
&=9\left[\frac{1}{2}\arctan\!\left(\frac{x-1}{2}\right)\right]_{-1}^{4} \\
&=\frac{9}{2}\left[\arctan\!\left(\frac{x-1}{2}\right)\right]_{-1}^{4} \\
...
\arcsin\!\left(\frac{x}{a}\right)+c
\]
with \(a=2\) and \(x\) replaced by \(\ln x\), noting that \(\dfrac{\mathrm{d}}{\mathrm{d}x}(\ln x)=\dfrac{1}{x}\),
\[
\int_1^{e} \frac{1}{x\sqrt{4-(\ln x)^2}} \,\mathrm{d}x
=
\left[\arcsin\!\left(\frac{\ln x}{2}\right)\right]_1^e
\]
