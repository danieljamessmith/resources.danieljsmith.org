...
\djsSolnHeader{Volumes of Revolution}
...
% ---- Question 1 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q1]

\begin{enumerate}[label=\textbf{(\alph*)}]
  \item Show that
  \[
  \frac{\mathrm{d}}{\mathrm{d}x}\ln(\sec x+\tan x)=\sec x
  \]
  \marks[-20pt]{2}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{(\alph*)}, resume]
  \item Find the exact volume of the solid generated. \marks{3} \\
\end{enumerate}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  \item Let $u=\sec x+\tan x$. Differentiating,
  \[
  \frac{\mathrm{d}u}{\mathrm{d}x}=\sec x\tan x+\sec^2 x=\sec x(\tan x+\sec x)=u\sec x
  \]

  Hence, by the chain rule,
  \[
  \frac{\mathrm{d}}{\mathrm{d}x}\ln(\sec x+\tan x)=\frac{1}{u}\cdot\frac{\mathrm{d}u}{\mathrm{d}x}=\frac{1}{u}\cdot u\sec x=\sec x
  \]
  as required.

  \item Since the region is rotated about the $x$-axis, the volume is
  \[
...
% ---- Question 2 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q2]
...
% ---- Question 3 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q3]
...
% ---- Question 4 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q4]
...
\addplot[thick, black, samples=200, domain=0:2.4, variable=\u]
    ({6/(1+\u^2)}, {\u})
    node[pos=0.85, above right] {$C$};

\addplot[dashed, black] coordinates {(0,\ya) (\xa,\ya)};
\addplot[dashed, black] coordinates {(0,\yb) (\xb,\yb)};

\node[below left] at (axis cs:0,0) {$O$};
\node[left] at (axis cs:0,\ya) {$1/\sqrt{3}$};
\node[left] at (axis cs:0,\yb) {$\sqrt{3}$};
\node at (axis cs:2.0,1.1) {$R$};
...
The finite region $R$ shown in the diagram is bounded by $C$, the lines $y=\dfrac{1}{\sqrt{3}}$, $y=\sqrt{3}$ and the $y$-axis. Region $R$ is rotated through $2\pi$ radians about the $y$-axis to form a solid of revolution. \\
\begin{enumerate}[label=\textbf{(\alph*)}, resume]
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  ...
  When $y=\sqrt3$,
  \[
  \cot\theta=\sqrt3\implies\tan\theta=\frac{1}{\sqrt3}
  \]
  so $\theta=\dfrac{\pi}{6}$.

  When $y=\dfrac{1}{\sqrt3}$,
  \[
  \cot\theta=\frac{1}{\sqrt3}\implies\tan\theta=\sqrt3
  \]
  so $\theta=\dfrac{\pi}{3}$.
  ...
  \begin{align*}
  V
  &=\pi\int_{1/\sqrt3}^{\sqrt3} x^2\,\mathrm{d}y \\
  &=\pi\int_{\pi/3}^{\pi/6} (6\sin^2\theta)^2\frac{\mathrm{d}y}{\mathrm{d}\theta}\,\mathrm{d}\theta \\
  &=\pi\int_{\pi/3}^{\pi/6} (6\sin^2\theta)^2(-\operatorname{cosec}^2\theta)\,\mathrm{d}\theta \\
  &=36\pi\int_{\pi/3}^{\pi/6} -\sin^2\theta\,\mathrm{d}\theta \\
  &=36\pi\int_{\pi/6}^{\pi/3} \sin^2\theta\,\mathrm{d}\theta
  \end{align*}
  ...
  with
  \[
  k=36\pi,\qquad a=\frac{\pi}{6},\qquad b=\frac{\pi}{3}
  \]
  ...
  V
  &=36\pi\int_{\pi/6}^{\pi/3}\sin^2\theta\,\mathrm{d}\theta \\
  &=36\pi\left[\frac{\theta}{2}-\frac{\sin 2\theta}{4}\right]_{\pi/6}^{\pi/3} \\
  &=36\pi\left(\frac{\pi}{6}-\frac{\sin(2\pi/3)}{4}-\frac{\pi}{12}+\frac{\sin(\pi/3)}{4}\right)
  \end{align*}
  ...
  \begin{align*}
  V
  &=36\pi\left(\frac{\pi}{6}-\frac{\pi}{12}\right) \\
  &=36\pi\cdot\frac{\pi}{12} \\
  &=3\pi^2
  \end{align*}
...
% ---- Question 5 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q5]

\begin{enumerate}[label=\textbf{(\alph*)}]
  \item Show that $\sinh(2\ln 2)=\dfrac{15}{8}$ \marks{2} \\
\end{enumerate}
...
% ---- Question 6 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q6]
...
% ---- Question 7 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q7]
...
% ---- Question 8 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q8]
...
% ---- Question 9 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q9]
...
% ---- Question 10 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q10]
...
% ---- Question 11 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q11]
...
% ---- Question 12 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q12]
...
% ---- Question 13 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q13]
...
% ---- Question 14 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q14]
...
% ---- Question 15 ----
\questionitem
% [Source: _QBT___Solns__Volumes_of_Revolution, Q15]
