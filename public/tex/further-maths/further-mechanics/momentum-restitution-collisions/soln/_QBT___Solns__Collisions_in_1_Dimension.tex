...
\djsSolnHeader{Collisions in 1 Dimension}
...
% ---- Question 1 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q1]
...
% ---- Question 2 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q2]
...
\node at ($(A)+(0,0.18)$) {$A$};
\node at ($(A)+(0,-0.14)$) {$1\,\mathrm{kg}$};
\node at ($(B)+(0,0.18)$) {$B$};
\node at ($(B)+(0,-0.14)$) {$3\,\mathrm{kg}$};
\end{tikzpicture}
\end{figure}
...
\node at ($(C)+(0,0.18)$) {$C$};
\node at ($(C)+(0,-0.14)$) {$2\,\mathrm{kg}$};
\node at ($(D)+(0,0.18)$) {$D$};
\node at ($(D)+(0,-0.14)$) {$5\,\mathrm{kg}$};
\end{tikzpicture}
\end{figure}
...
% ---- Question 3 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q3]
...
% ---- Question 4 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q4]
...
% ---- Question 5 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q5]
...
% ---- Question 6 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q6]
...
% ---- Question 7 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q7]
...
% ---- Question 8 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q8]
...
% ---- Question 9 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q9]
...
% ---- Question 10 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q10]
...
\draw[-{Stealth[length=3mm]}, thick] ($(B)+(0.85,0.65)$) -- ++(-1.3,0) node[midway, above, xshift=5pt] {$2\,\mathrm{m\,s^{-1}}$};
\node[left] at ($(A)+(-0.25,0.05)$) {$1\,\mathrm{kg}$};
\node[right] at ($(B)+(0.25,0.05)$) {$2\,\mathrm{kg}$};
...
% ---- Question 11 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q11]
...
% ---- Question 12 ----
\questionitem
% [Source: _QBT___Solns__Collisions_in_1_Dimension, Q12]
