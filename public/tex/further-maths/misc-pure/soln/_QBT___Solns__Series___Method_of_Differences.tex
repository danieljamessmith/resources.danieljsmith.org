...
To use the method of differences, first write the general term as a difference of two simpler fractions:
\[
\frac{3}{(2r-1)(2r+1)}-\frac{3}{(2r+1)(2r+3)}
\]

Checking this:
\begin{align*}
\frac{3}{(2r-1)(2r+1)}-\frac{3}{(2r+1)(2r+3)}
&=\frac{3(2r+3)-3(2r-1)}{(2r-1)(2r+1)(2r+3)}\\
&=\frac{6r+9-6r+3}{(2r-1)(2r+1)(2r+3)}\\
&=\frac{12}{(2r-1)(2r+1)(2r+3)}
\end{align*}

So
\[
S_n=3\sum_{r=1}^{n}\left(\frac{1}{(2r-1)(2r+1)}-\frac{1}{(2r+1)(2r+3)}\right)
\]
...
S_n
&=3\Bigg[
\left(\frac{1}{1\cdot3}-\frac{1}{3\cdot5}\right)
+\left(\frac{1}{3\cdot5}-\frac{1}{5\cdot7}\right)
+\left(\frac{1}{5\cdot7}-\frac{1}{7\cdot9}\right)
+\cdots\\
&\qquad\qquad\qquad\qquad
+\left(\frac{1}{(2n-1)(2n+1)}-\frac{1}{(2n+1)(2n+3)}\right)
\Bigg]
\end{align*}

The middle terms cancel in pairs:
\begin{align*}
S_n
&=3\Bigg[
\frac{1}{1\cdot3}
-\cxl{blue}{\frac{1}{3\cdot5}}
+\cxl{blue}{\frac{1}{3\cdot5}}
-\cxl{red}{\frac{1}{5\cdot7}}
+\cxl{red}{\frac{1}{5\cdot7}}
-\cdots
-\frac{1}{(2n+1)(2n+3)}
\Bigg]\\
&=3\left(\frac{1}{1\cdot3}-\frac{1}{(2n+1)(2n+3)}\right)
\end{align*}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
  \item Use standard results from formula book to show that
  \[
